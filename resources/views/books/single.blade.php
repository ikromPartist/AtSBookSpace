      ...
      <div class="container">
         ...
         <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs__item">
               ...
               <a class="breadcrumbs__link" href="{{route('books.index')}}">
                  {{__('Книги')}}
               </a>
            </li>
            ...
            @if ($book->category != 'all')
               ...
               <li class="breadcrumbs__item">
                  ...
                  <a class="breadcrumbs__link" href="{{route('books.index', $book->category)}}">
                     {{$book->category}}
                  </a>
               </li>
            ...
            <section class="book-info">
               ...
               <div class="book-info__status-wrapper">
                  ...
                  @if (!$book->user)
                     ...
                     <p class="book-info__status book-info__status--available">
                        {{__('Доступна')}}
                     </p>
               ...
               <ul class="book-info__list">
                  <li class="book-info__item">
                     <div class="book-info__dt">
                        {{__('Автор')}}
                     </div>
                     <div class="book-info__dd">
                        <span class="material-icons-outlined book-info__arrow-icon">
                           arrow_forward_ios
                        </span>
                        {{$book->author}}
                     </div>
               ...
               <div class="book-info__rating-wrapper">
                  <div class="book-info__stars-wrapper">
                     <span class="material-icons-outlined book-info__rating-icons {{$book->rating >= 1 ? 'filled' : ''}}" data-id="rating-icon">
                        star_border
                     </span>
                     <span class="material-icons-outlined book-info__rating-icons {{$book->rating >= 2 ? 'filled' : ''}}" data-id="rating-icon">
                        star_border
                     </span>
                     <span class="material-icons-outlined book-info__rating-icons {{$book->rating >= 3 ? 'filled' : ''}}" data-id="rating-icon">
                        star_border
                     </span>
                     <span class="material-icons-outlined book-info__rating-icons {{$book->rating >= 4 ? 'filled' : ''}}" data-id="rating-icon">
                        star_border
                     </span>
                     <span class="material-icons-outlined book-info__rating-icons {{$book->rating >= 5 ? 'filled' : ''}}" data-id="rating-icon">
                        star_border
                     </span>
                  </div>
                  <button class="book-info__rating-link" type="button" data-id="show-rating-modal">
                     {{__('Оценить')}}
                  </button>
               </div>
               ...
               <a class="button book-info__book-link" href="#">
                  {{__('Забронировать')}}
               </a>
            ...
            <form class="comment-form">
               ...
               @csrf
                  ...
                  <div class="comment__buttons-wrapper" data-id="buttons-wrapper">
                     <button class="button button--red" type="reset" data-id="cancel-comment">
                        {{__('Отмена')}}
                     </button>
                     <button class="button" type="submit" data-id="submit-comment" data-book="{{$book->id}}">
                        {{__('Комментировать')}}
                     </button>
                  </div>
         ...
         <div class="modal hidden" data-id="rating-modal">
            ...
            <div class="rating__stars-wrapper">
               ...
               <span class="material-icons book-info__rating-icons book-info__rating-icons--white {{$rate >= 5 ? 'grey' : ''}}" data-id="rating-icon-1" data-book="{{$book->id}}">
                  star
               </span>
               <span class="material-icons book-info__rating-icons book-info__rating-icons--white {{$rate >= 4 ? 'grey' : ''}}" data-id="rating-icon-2" data-book="{{$book->id}}">
                  star
               </span>
               <span class="material-icons book-info__rating-icons book-info__rating-icons--white {{$rate >= 3 ? 'grey' : ''}}" data-id="rating-icon-3" data-book="{{$book->id}}">
                  star
               </span>
               <span class="material-icons book-info__rating-icons book-info__rating-icons--white {{$rate >= 2 ? 'grey' : ''}}" data-id="rating-icon-4" data-book="{{$book->id}}">
                  star
               </span>
               <span class="material-icons book-info__rating-icons book-info__rating-icons--white {{$rate >= 1 ? 'grey' : ''}}" data-id="rating-icon-5" data-book="{{$book->id}}">
                  star
               </span>
            </div>{{-- stars wrapper end --}}

            <div class="modal__btn-wrapper">
               <button class="button button--red" type="button" data-id="rating__cancel-btn">
                  {{__('Отмена')}}
               </button>
            </div>

            <button class="modal__close-btn" aria-label="{{__('Закрыть')}}">
               <span class="material-icons modal__close-icon" data-id="rating__close-btn">
                  close
               </span>
            </button>
         ...
         <div class="modal hidden" data-id="rating-success">
            ...
            <div class="modal__btn-wrapper">
               <button class="button" type="button" data-id="rating__ok-btn">
                  {{__('OK')}}
               </button>
            </div>
