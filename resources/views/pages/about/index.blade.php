         ...
         <div class="container">
            <ul class="breadcrumbs__list">
               ...
               <li class="breadcrumbs__item">
                  ...
                  <a class="breadcrumbs__link" tabindex="0">О клубе</a>
               </li>
            </ul>
         </div>
      </section>
      <div class="container">
         <h1 class="heading">О клубе</h1>   
         <section class="about">
            <div class="about__wrapper">
               ...
               <ul class="about__strategy">
                  <li class="about__strategy-item">
                     <span class="material-icons about__strategy-icon">arrow_right_alt</span>
            ...
            <div class="about__image-wrapper" >
               <img class="about__image" src="{{asset('img/about/about.png')}}" alt="Обучение-залог вашего развития">
            </div>
         </section>{{-- about end --}}

         <section class="plan">
            <h2 class="title plan__title">Наши планы</h2>
            <div class="plan__image-wrapper">
               <img class="plan__image" src="{{asset('img/about/plan.png')}}" alt="Наши цели">
            </div>
            <div class="plans__wrapper">
               <ul class="plans">
                  <li class="plans__item">
                     <span class="material-icons plans__icon">arrow_right_alt</span>
      ...
      <section class="training">
         <div class="container training__container">
            ...
            <div class="training__image-wrapper">
               <img class="training__image" src="{{asset('img/about/training.png')}}" alt="Процесс обучения сотрудников">
            </div>
         </div>
