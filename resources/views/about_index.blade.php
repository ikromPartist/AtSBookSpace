   ...
   <main class="about-page">
      <div class="container">
         ...
         <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs__item">
               ...
               <a tabindex="0" class="breadcrumbs__link">{{__('О клубе')}}</a>
            </li>
         </ul>
         ...
         <section class="plan">
            <h2 class="title plan__title">{{__('Наши планы')}}</h2>
            ...
            <div class="plans__wrapper">
               <ul class="plans">
                  <li class="plans__item">
                     <span class="material-icons-outlined plans__icon">arrow_right_alt</span>
      ...
      <section class="training">
         <div class="container training__container">
            ...
            <h2 class="visually-hidden">{{__('Корпоративное обучение')}}</h2>
