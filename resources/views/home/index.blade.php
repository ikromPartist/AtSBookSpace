      ...
      <div class="container">
         ...
         <section class="categories">
            ...
            <ul class="categories__list">
               <li class="categories__item">
                  ...
                  <a class="categories__link" href="{{route('books.index')}}?category=Soft%20skills">
                     {{__('Посмотреть все')}}
                  </a>
               </li>
               <li class="categories__item">
                  ...
                  <a class="categories__link" href="{{route('books.index')}}?category=Hard%20skills">
                     {{__('Посмотреть все')}}
                  </a>
               </li>
               <li class="categories__item">
                  ...
                  <a class="categories__link" href="{{route('books.index')}}?category=Маркетинг">
                     {{__('Посмотреть все')}}
                  </a>
               </li>
               <li class="categories__item">
                  ...
                  <a class="categories__link" href="{{route('books.index')}}?category=Менеджмент">
                     {{__('Посмотреть все')}}
                  </a>
               </li>
               <li class="categories__item">
                  ...
                  <a class="categories__link" href="{{route('books.index')}}?category=Финансы">
                     {{__('Посмотреть все')}}
                  </a>
               </li>
               <li class="categories__item">
                  ...
                  <a class="categories__link" href="{{route('books.index')}}?category=Staff%20менеджмент">
                     {{__('Посмотреть все')}}
                  </a>
               </li>
               <li class="categories__item">
                  ...
                  <a class="categories__link" href="{{route('books.index')}}?category=Продажи%20и%20переговоры">
                     {{__('Посмотреть все')}}
                  </a>
               </li>
               <li class="categories__item">
                  ...
                  <a class="categories__link" href="{{route('books.index')}}?category=Сервис">
                     {{__('Посмотреть все')}}
                  </a>
               </li>
               <li class="categories__item">
                  ...
                  <a class="categories__link" href="{{route('books.index')}}?category=ИТ">
                     {{__('Посмотреть все')}}
                  </a>
               </li>
               <li class="categories__item">
                  ...
                  <a class="categories__link" href="{{route('books.index')}}?category=Художественная%20литература">
                     {{__('Посмотреть все')}}
                  </a>
               </li>
            </ul>
         ...
         <section class="popular-books">
            ...
            <div class="cat-title__container">
               ...
               <a class="link cat-title__link" href="{{route('books.index')}}">
                  {{__('Все книги')}}
               </a>
            </div>
         ...
         <article class="about">
            ...
            <section class="about__intro">
               ...
               <div>
                  <a class="link" href="{{route('about.index')}}">
                     {{__('Подробнее о клубе')}}
                  </a>
               </div>
