   ...
   @if ($mstActRdrs != null)
      ...
      <ul class="list rating-view__list">
         <li class="list__item rating-view__item">
            <p class="active-reader__name">
               {{__('Имя и фамилия')}}
            </p>
            <p class="active-reader__company">
               {{__('Компания')}}
            </p>
            <p class="active-reader__pages">
               {{__('Страниц')}}
               <small>
                  {{__(' (прочитано)')}}
               </small>
            </p>
            <p class="active-reader__books">
               {{__('Книг')}}
               <small>
                  {{__(' (прочитано)')}}
               </small>
         ...
         @foreach ($mstActRdrs as $reader)
            ...
            <li class="list__item rating-view__item {{$reader->id == $loggedUser->id ? 'rating-view__item--user' : ''}}">
               ...
               <p class="active-reader__books">
                  {{$reader->taken_books_count}}
               </p>
            </li>

         @endforeach

      </ul>{{-- most active reader end --}}           
   ...
   @if ($mstRdngCmpnys != null)
      ...
      <ul class="list rating-view__list">
         <li class="list__item rating-view__item">
            ...
            <p class="company__read-pages">
               {{__('Страниц')}}
               <small>
                  {{__(' (прочитано)')}}
               </small>
            </p>
            <p class="company__read-books">
               {{__('Книг')}}
               <small>
                  {{__(' (прочитано)')}}
               </small>
            </p>
            <p class="company__employees">
               {{__('Сотрудники')}}
               <small>
                  {{__(' (читающие)')}}
               </small>
   ...
   @if ($mstDscplndRdrs != null)
      ...
      <ul class="list rating-view__list">
         <li class="list__item rating-view__item">
            <p class="disciplined-reader__name">
               {{__('Имя и фамилия')}}
            </p>
            <p class="disciplined-reader__company">
               {{__('Компания')}}
            </p>
            <p class="disciplined-reader__blacklist-value">
               {{__('К-во нарушений')}}
            </p>
            <p class="disciplined-reader__renewed-deadlines">
               {{__('Дедлайны')}}
               <small>
                  {{__(' (продленные)')}}
               </small>
         ...
         @foreach ($mstDscplndRdrs as $reader)
            ...
            <li class="list__item rating-view__item {{$reader->id == $loggedUser->id ? 'rating-view__item--user' : ''}}">
               ...
               <p class="disciplined-reader__blacklist-value">
                  {{$reader->blacklist_value}}
               </p>
               <p class="disciplined-reader__renewed-deadlines">
                  {{$reader->renewed_deadlines}}
               </p>
            </li>

         @endforeach

      </ul>{{-- most disciplined reader end --}}         
      ...
      <ul class="list rating-view__list">
         ...
         @foreach ($mstPplrBooks as $book)
            ...
            <li class="list__item rating-view__item {{$book->id == $loggedUser->book->id ? 'rating-view__item--user' : ''}}">
               <p class="popular-book__title">
                  {{$rank++}}. 
                  {{$book->title}}
               </p>
               <p class="popular-book__author">
                  {{$book->author}}
               </p>
               <p class="popular-book__likes">
                  {{$book->likes_count}}
               </p>
               <p class="popular-book__comments">
                  {{$book->comments_count}}
               </p>
            </li>
